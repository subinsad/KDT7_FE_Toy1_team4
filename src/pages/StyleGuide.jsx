    ...
    return (
        <div>
            ...
            <Button
                ...
                text="btn regular primary"
            />
            <Button
                className={'btn regular danger'}
                text="btn regular danger"
            />
            <Button
                className={'btn regular success'}
                text="btn regular success"
            />
            ...
            <Button
                ...
                text="btn xsmall primary"
            />
            <Button className={'btn xsmall danger'} text="btn xsmall danger" />
            <Button
                className={'btn xsmall success'}
                text="btn xsmall success"
            />
            ...
            <Block className="mypage__wrapper">
                ...
                <div className="mypage__inner">
                    <div className="mypage__profile">
                        ...
                        <div className="mypage__memo">
                            한 줄 소개글이 등록되어 있지 않습니다.
                        </div>
                    </div>
